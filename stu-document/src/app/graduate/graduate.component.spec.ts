...
describe('graduateComponent', () => {
  ...
  let mockgraduateService;
  let mockDataService

  beforeEach(async(() => {

    mockgraduateService = sinon.createStubInstance(graduateService);
    mockgraduateService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: graduateService, useValue: mockgraduateService },
